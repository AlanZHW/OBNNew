    ...
    ,m_node(owner)
{
    ...
    connect(this,SIGNAL(signalStartWork(const int&,const QVariant&)),
            m_nodeFtp,SLOT(startWork(const int&,const QVariant&)),Qt::QueuedConnection);
    connect(this,SIGNAL(signalTimerInfo(const QString&,const QString&,const QString&)),
            m_nodeFtp,SLOT(startTimerInfo(const QString&,const QString&,const QString&)),Qt::QueuedConnection);
