...
void NodeFtp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NodeFtp *_t = static_cast<NodeFtp *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (NodeFtp::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeFtp::memoryChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (NodeFtp::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeFtp::frequencyChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (NodeFtp::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeFtp::downloadPercentChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (NodeFtp::*_t)(int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeFtp::finishedFtpWork)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (NodeFtp::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeFtp::noteChanged)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject NodeFtp::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NodeFtp.data,
      qt_meta_data_NodeFtp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NodeFtp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NodeFtp.stringdata0))
        return static_cast<void*>(const_cast< NodeFtp*>(this));
