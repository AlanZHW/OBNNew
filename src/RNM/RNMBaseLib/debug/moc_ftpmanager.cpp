...
void FtpManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FtpManager::*_t)(const int & , const QVariant & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FtpManager::signalStartWork)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FtpManager::*_t)(const QString & , const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FtpManager::signalTimerInfo)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FtpManager::signalStopWork)) {
                *result = 2;
                return;
            }
        }
