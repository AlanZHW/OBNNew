...
void SearchThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SearchThread::*_t)(quint32 , const bool & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchThread::searchedHost)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SearchThread::*_t)(const int & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchThread::searchFinished)) {
                *result = 2;
                return;
            }
        }
