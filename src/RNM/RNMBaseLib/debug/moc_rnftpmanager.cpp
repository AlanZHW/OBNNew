...
void RNFtpManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RNFtpManager *_t = static_cast<RNFtpManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject RNFtpManager::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RNFtpManager.data,
      qt_meta_data_RNFtpManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RNFtpManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RNFtpManager.stringdata0))
        return static_cast<void*>(const_cast< RNFtpManager*>(this));
