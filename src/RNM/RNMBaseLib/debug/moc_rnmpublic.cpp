...
void Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Node::*_t)(const int & , const QVariant & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Node::signalFtpStart)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject NodeMediator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NodeMediator.data,
      qt_meta_data_NodeMediator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NodeMediator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NodeMediator.stringdata0))
        return static_cast<void*>(const_cast< NodeMediator*>(this));
    return QObject::qt_metacast(_clname);
}
