...
void FiltersBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FiltersBox *_t = static_cast<FiltersBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (FiltersBox::*_t)(const int & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FiltersBox::displayFiltersChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FiltersBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FiltersBox::reportNodeStatus)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject FiltersBox::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_FiltersBox.data,
      qt_meta_data_FiltersBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FiltersBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FiltersBox.stringdata0))
        return static_cast<void*>(const_cast< FiltersBox*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LegendBox *_t = static_cast<LegendBox *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (LegendBox::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LegendBox::reportNodeStatus)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject LegendBox::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_LegendBox.data,
      qt_meta_data_LegendBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LegendBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LegendBox.stringdata0))
        return static_cast<void*>(const_cast< LegendBox*>(this));
    return QGroupBox::qt_metacast(_clname);
}
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RNMSideBar *_t = static_cast<RNMSideBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->reportNodeStatus(); break;
        case 1: _t->displayFiltersChanged((*reinterpret_cast< const int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (RNMSideBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RNMSideBar::reportNodeStatus)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (RNMSideBar::*_t)(const int & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RNMSideBar::displayFiltersChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject RNMSideBar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RNMSideBar.data,
      qt_meta_data_RNMSideBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RNMSideBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RNMSideBar.stringdata0))
        return static_cast<void*>(const_cast< RNMSideBar*>(this));
