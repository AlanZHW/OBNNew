/****************************************************************************
** Meta object code from reading C++ file 'postioncontrols.h'
**
...
#error "The header file 'postioncontrols.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 11), // "sideBarHide"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "hide"
QT_MOC_LITERAL(4, 27, 21), // "slotSidebarBtnClicked"
QT_MOC_LITERAL(5, 49, 7) // "checked"

    },
    "TitleBar\0sideBarHide\0\0hide\0"
    "slotSidebarBtnClicked\0checked"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sideBarHide((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->slotSidebarBtnClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleBar::sideBarHide)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TitleBar::sideBarHide(bool _t1)
{
